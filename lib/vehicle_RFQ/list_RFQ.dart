...
import 'package:tatadelearapp/vehicle_RFQ/view_order_details.dart';
...
import 'list_RFQ_by_status.dart';




class ListRFQ extends StatefulWidget {
  final ListRFQArgs args;

  const ListRFQ({Key? key, required this.args}) : super(key: key);

  @override
  State<ListRFQ> createState() => _ListRFQState();
}

class _ListRFQState extends State<ListRFQ> {
  @override
  void  initState(){
    super.initState();
                              ...
                              children: [
                                ...
                                const Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children:   [
                                      Text("List of Requested Quotation", style: TextStyle(color: Colors.indigo, fontSize: 18, fontWeight: FontWeight.bold),
                                      ),
